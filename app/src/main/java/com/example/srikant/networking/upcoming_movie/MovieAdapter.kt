package com.example.srikant.networking.upcoming_movie
...
class MovieAdapter(var moviePresenter: MoviePresenter<UpcomingMovieView>) : androidx.recyclerview.widget.RecyclerView.Adapter<MovieAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View,var moviePresenter: MoviePresenter<UpcomingMovieView>) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView), IMovieHolder,View.OnClickListener {
